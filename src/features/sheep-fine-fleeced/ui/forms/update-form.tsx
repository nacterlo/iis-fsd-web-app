import { SheepFineFleeced, UpdateSheepFineFleeced } from "../../model/types"
...
interface UpdateFormProps {
    initialData: SheepFineFleeced
    onSubmitUpdate: (data: UpdateSheepFineFleeced) => void
}

export const FormUpdateSheepFineFleeced = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
        watch,
        formState: { errors },
    } = useForm<UpdateSheepFineFleeced>();
