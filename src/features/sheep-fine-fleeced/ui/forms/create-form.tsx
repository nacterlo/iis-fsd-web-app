...
import { CreateSheepFineFleeced } from "../../model/types";
...
interface CreateFormProps {
    onSubmitCreate: (data: CreateSheepFineFleeced) => Promise<void>;
}


export const FormCreateSheepFineFleeced = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateSheepFineFleeced>()
    ...
    const onSubmit: SubmitHandler<CreateSheepFineFleeced> = async (data) => {
    ...
    return (
        <form id="createSheepFineFleeced" onSubmit={handleSubmit(onSubmit)}>
