...
import { FormValuesHorse, Horse, UpdateHorse } from "../../model/types"
...
interface UpdateFormProps {
    initialData: Horse
    onSubmitUpdate: (data: UpdateHorse) => void
}

export const UpdateFormHorse = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    useEffect(() => {
        reset({
            ...
            graphicDescription: initialData.graphicDescription,
    ...
    const onSubmit: SubmitHandler<FormValuesHorse> = (data) => {
        console.log(data);
        const updateData: UpdateHorse = {
    ...
    return (
        <form id="updateHorse" onSubmit={handleSubmit(onSubmit)}>
