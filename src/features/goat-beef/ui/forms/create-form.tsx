...
interface CreateFormProps {
    onSubmitCreate: (data: CreateGoatBeef) => Promise<void>
}

export const FormCreateGoatBeef = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateGoatBeef>()
    ...
    const onSubmit: SubmitHandler<CreateGoatBeef> = async (data) => {
    ...
    return (
        <form id="createGoatBeef" onSubmit={handleSubmit(onSubmit)}>
