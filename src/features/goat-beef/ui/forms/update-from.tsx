...
import { GoatBeef, UpdateGoatBeef } from "../../model/types";
...
interface UpdateFormProps {
    initialData: GoatBeef
    onSubmitUpdate: (data: UpdateGoatBeef) => void
}


export const FormUpdateGoatBeef = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    const onSubmit: SubmitHandler<UpdateGoatBeef> = (data) => {
        onSubmitUpdate(data)
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} id='updateGoatBeef'>
