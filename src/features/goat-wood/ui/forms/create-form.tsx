...
interface CreateFormProps {
    onSubmitCreate: (data: CreateGoatWood) => Promise<void>
}

export const FormCreateGoatWood = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateGoatWood>()
    ...
    const onSubmit: SubmitHandler<CreateGoatWood> = async (data) => {
    ...
    return (
        <form id="createGoatWood" onSubmit={handleSubmit(onSubmit)}>
