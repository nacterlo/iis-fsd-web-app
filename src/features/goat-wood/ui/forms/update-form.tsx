...
import { GoatWood, UpdateGoatWood } from "../../model/types";
...
interface UpdateFormProps {
    initialData: GoatWood
    onSubmitUpdate: (data: UpdateGoatWood) => void
}


export const FormUpdateGoatWood = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    const onSubmit: SubmitHandler<UpdateGoatWood> = (data) => {
        onSubmitUpdate(data)
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} id='updateGoatWood'>
