import { GoatDairy, UpdateGoatDairy } from "../../model/types"
...
interface UpdateFormProps {
    initialData: GoatDairy
    onSubmitUpdate: (data: UpdateGoatDairy) => void
}



export const FormUpdateGoatDairy = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    useEffect(() => {
        reset({
            ...
            valueIndex: initialData.valueIndex,
        })

    }, [initialData, reset])

    const onSubmit: SubmitHandler<UpdateGoatDairy> = (data) => {
        onSubmitUpdate(data)
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} id='updateGoatDairy'>
