...
import { CreateSheepMeatShorthair } from "../../model/types";


interface CreateFormProps {
    onSubmitCreate: (data: CreateSheepMeatShorthair) => Promise<void>;
}


export const FormCreateSheepMeatShorthair = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateSheepMeatShorthair>()
    ...
    const onSubmit: SubmitHandler<CreateSheepMeatShorthair> = async (data) => {
    ...
    return (
        <form id="createSheepMeatShorthair" onSubmit={handleSubmit(onSubmit)}>
