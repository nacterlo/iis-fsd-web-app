...
import { useGetSpermAndEmbryosListQuery } from "../api/sperm-and-embryos-api"
    ...
    return (
        ...
        >
            ...
            <Table
                ...
                stickyHeader
                hoverRow={spermEmbryosList && !loadingSpermEmbryos || !isError || !!spermEmbryosList?.data}
                sx={{
