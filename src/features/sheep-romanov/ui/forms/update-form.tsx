import { SheepRomanov, UpdateSheepRomanov } from "../../model/types"
...
interface UpdateFormProps {
    initialData: SheepRomanov
    onSubmitUpdate: (data: UpdateSheepRomanov) => void
}

export const FormUpdateSheepRomanov = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    const onSubmit: SubmitHandler<UpdateSheepRomanov> = (data) => {
        onSubmitUpdate(data)
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} id='updateSheepRomanov'>
