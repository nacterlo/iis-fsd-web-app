...
import { CreateSheepRomanov } from "../../model/types";


interface CreateFormProps {
    onSubmitCreate: (data: CreateSheepRomanov) => Promise<void>;
}


export const FormCreateSheepRomanov = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateSheepRomanov>()
    ...
    const onSubmit: SubmitHandler<CreateSheepRomanov> = async (data) => {
    ...
    return (
        <form id="createSheepRomanov" onSubmit={handleSubmit(onSubmit)}>
