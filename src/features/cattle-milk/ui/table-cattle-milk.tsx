...
import { useGetCattleMilkListQuery } from "../api/cattle-milk-api"
    ...
    return (
        ...
        >
            ...
            <Table
                ...
                stickyHeader
                hoverRow={cattleMilkList && !loadingCattleMilkList || !isError || !!cattleMilkList?.data}
                sx={{
            ...
            >
                ...
                {cattleMilkList && cattleMilkList.data ? (
                    <tbody>
                        {cattleMilkList.data.length === 0 ? (
                            <TableNoData />
                        ) : null}
                        {[...cattleMilkList.data].map((animal, index) => (
