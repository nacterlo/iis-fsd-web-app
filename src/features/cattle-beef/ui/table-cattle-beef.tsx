...
import { useGetCattleBeefListQuery } from "../api/cattle-beef-api"




interface TableCattleBeefProps {
    ...
    return (
        ...
        >
            ...
            <Table
                ...
                stickyHeader
                hoverRow={cattleBeefList && !loadingCattleMilkList || !isError || !!cattleBeefList?.data}
                sx={{
            ...
            >
                ...
                {cattleBeefList && cattleBeefList.data ? (
                    <tbody>
                        {cattleBeefList.data.length === 0 ? (
                            <TableNoData />
                        ) : null}
                        {[...cattleBeefList.data].map((animal, index) => (
