...
import { CreateSheepRough } from "../../model/types";


interface CreateFormProps {
    onSubmitCreate: (data: CreateSheepRough) => Promise<void>;
}


export const FormCreateSheepRough = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateSheepRough>()
    ...
    const onSubmit: SubmitHandler<CreateSheepRough> = async (data) => {
    ...
    return (
        <form id="createSheepRough" onSubmit={handleSubmit(onSubmit)}>
