...
import { SheepRough, UpdateSheepRough } from "../../model/types";

interface UpdateFormProps {
    initialData: SheepRough
    onSubmitUpdate: (data: UpdateSheepRough) => void
}

export const FormUpdateSheepRough = ({ initialData, onSubmitUpdate }: UpdateFormProps) => {
    const {
        control,
        handleSubmit,
        reset,
    ...
    const onSubmit: SubmitHandler<UpdateSheepRough> = (data) => {
        onSubmitUpdate(data)
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} id='updateSheepRough'>
