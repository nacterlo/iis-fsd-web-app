...
interface CreateFormProps {
    onSubmitCreate: (data: CreateGoatDowny) => Promise<void>
}

export const FormCreateGoatDowny = ({ onSubmitCreate }: CreateFormProps) => {
    const {
        control,
        handleSubmit,
        watch,
        formState: { errors },
    } = useForm<CreateGoatDowny>()
    ...
    const onSubmit: SubmitHandler<CreateGoatDowny> = async (data) => {
    ...
    return (
        <form id="createGoatDowny" onSubmit={handleSubmit(onSubmit)}>
